...
Usage: foxbox [-v] [-h] [-l <hostname>] [-p <port>] [-w <wsport>] [-d <profile_path>] [-r <url>] [-i <iface>] [-t <tunnel>] [-s <secret>] [--disable-tls] [--remote-name <hostname>] [--link-domain <domain>] [-c <namespace;key;value>]...
...
Options:
    ...
    -s, --tunnel-secret <secret>    Set the tunnel shared secret. [default: secret]
        ...
        --link-domain <domain>      Set the top level domain for public DNS [default: knilxof.org]
...
fn main() {
    ...
    let domain = args.flag_link_domain;
...
describe! main {
    describe! args {
        it "should have default values" {
            ...
            assert_eq!(args.flag_link_domain, "knilxof.org");
